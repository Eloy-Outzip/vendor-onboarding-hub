      ...
      <div className="mx-auto max-w-xl px-4 py-12 sm:py-20 space-y-8">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Add the types of equipment you rent out.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {categories.map((cat) => (
            <span
              key={cat.id}
              className="inline-flex items-center gap-1 rounded-full border bg-background px-3 py-1.5 text-sm font-medium"
            >
              {cat.name}
              <button
        ...
        <div className="flex gap-2">
          <Input
            ...
            placeholder="e.g. Tents, Lighting, AV Equipment"
            maxLength={100}
